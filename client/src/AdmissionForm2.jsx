...
const AdmissionForm2 = forwardRef(({ formDataB, setFormDataB, filePreviews, setFilePreviews, formData1, userId, setFormData1}, ref) => {
  ...
  const back_url = "https://pirates-beds-contracting-pavilion.trycloudflare.com";
          ...
          <table className="form-table table2">
            <thead>
              ...
              <th colSpan="4" className="title">
                <h3>First Year Admission Form (2024-25)</h3>
              </th>
            </tr>
            </thead>
            <tbody>
            ...
            <tr>
              ...
              <td>{formDataB.cetDetails.cetPer}</td>
            </tr>
            <tr className="sub-title">
            ...
            <tr>
                ...
                <td colSpan="3">
                <img
                      src={filePreviews.signature ? filePreviews.signature : getImageUrl('signature')}
                      alt="Signature" 
