...
export default function App() {
  ...
  const sectionsB = [
    ...
    <TransactionDetails ref={transactionDetailsRef} formData={formDataB} setFormData={setFormDataB} formData1={formData1} setFormData1={setFormData1} setError={setError} />,
    <DocumentUpload ref={documentUploadRef} prevUploadedDoc={prevUploadedDoc} formData={formDataB} setFormData={setFormDataB} dbRetrival={dbRetrival} filePreviews={filePreviews} setFilePreviews={setFilePreviews} setError={setError} />,
...
// Create a Date object from the string
        ...
        setFormDataB(prevState => ({
          ...
          formType: userData.formType || prevState.formType
        }));
        setdbRetrival(true);
        console.log("hello")
  ...
  const nextSectionB = () => {
    ...
    function checkAllDocumentsPresent(obj) {
      const fieldsToCheck = [
        'photo', 'marksheet10', 'leavingCertificate12', 'marksheet12', 'signature','transactionproof',
      ];
...
console.log(formDataB.personalDetails.class)
    ...
    if(formDataB.preference==="" || formData.preferences===null){
      alert("please select alloted branch");
      return;
    }else{
      setCurrentSection(currentSection + 1);
      setError('');
        ...
        if(formData1.transactionId==='' || formData1.date===''){
          // console.log("hello2")
      ...
      if(formDataB.personalDetails.admissionType==='CAP Level'){
