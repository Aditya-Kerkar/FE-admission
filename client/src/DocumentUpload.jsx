...
export default function DocumentUpload({ formData, setFormData, filePreviews,prevUploadedDoc, setFilePreviews, dbRetrival }) {
...
const docToRender = documentsToUpload.filter(doc => !prevUploadedLabels.has(doc.field));
...
// console.log(docToRender)
  ...
  return (
    <div>
      ...
      <center> <h5>(Please upload either your JEE marksheet or CET marksheet, based on your attempts in JEE , CET , or both .)</h5> </center>
